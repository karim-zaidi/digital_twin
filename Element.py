class Element():
    ...
    def __init__(self, p1, p2):
        assert isinstance(p1, tuple), f'p1 must be a tuple not a {type(p1).__name__}'
        assert isinstance(p2, tuple), f'p2 must be a tuple not a {type(p2).__name__}'
    ...
    @p1.setter
    def p1(self, new_p1):
        assert isinstance(new_p1, tuple), f'p1 must be a tuple not a {type(new_p1).__name__}'
    ...
    @p2.setter
    def p2(self, new_p2):
        assert isinstance(new_p2, tuple), f'p1 must be a tuple not a {type(new_p2).__name__}'
